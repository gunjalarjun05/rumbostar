...
$config['facebook']['appId'] = '305550129959595'; //Facebook App ID
$config['facebook']['appSecret'] = '4d5f9fc7b48dd582d18c0aefc588cc3b';

// $config['facebook']['homeurl'] = 'http://exceptionaire.co/rumbostar/user/social_redirect_apply_acc/facebook';  //return to home
$config['facebook']['homeurl'] = 'http://exceptionaire.co/rumbostar/user/social_redirect_apply_acc/facebook';  //return to home
$config['facebook']['fbPermissions'] = 'email';  //Required facebook permissions

$config['twitter']['apiKey'] = 'j00cVp2IaVdsoor62yDpe78P3'; //Facebook App ID
$config['twitter']['apiSecret'] = '5B0DyqjXNXpJpVEw0cTPEDRyITxcQgU3qFivcWnX9fIlUGIiUL'; // Facebook App Secret
