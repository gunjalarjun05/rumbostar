...
define('USER_INVITE_REFERRAL_CODE',PREFIX.'user_invite_referral_code');

define('CUST_INFO_BOOKING_DETAILS',PREFIX.'cust_info_booking_details');
define('CUST_TRAIN_BOOKING_DETAILS',PREFIX.'cust_train_booking_details
');
define('CUSTOMER_DETAILS',PREFIX.'customer_details');
define('CUSTOMER_TRAVELLING_DETAILS',PREFIX.'customer_travelling_details');

define('SOCIAL_SHARE_MASTER', PREFIX.'social_share_master');
...
define('LOYALTY_USER_DISCOUNT', PREFIX.'loyalty_user_discount');
...
define('HOTEL_BOOKING_DETAILS',PREFIX.'cust_hotel_booking_details');
define('FLIGHT_BOOKING_DETAILS',PREFIX.'flight_booking_details');
...
define('AGENT_REG_SUBJECT','Rumbostar account activation link');
$agentbody="<strong>Hello %USER_NAME%,</strong><br><br> Your account is Activated  successfully on Rumbostar.<br/>
			Please click below Link.</p><p><a href='%LINK%' target='_blank'>Activate Account</a> <br><br> Thanks and Regards <br> Rumbostar";
define('ACTIVE_AGENT_BODY',$agentbody);
...
//sk add following code for guest email verification
define('USER_GUEST_SUBJECT','Rumbostar Email verification link');
$guestbody="<strong>Hello %USER_NAME%,</strong><br><br> Your email is verify successfully on Rumbostar.<br/>";
define('GUEST_BODY',$guestbody);

//sk add following code for user invite friend Referal Code  %MY_REFERAL_CODE%,<br/>
define('FRIEND_REG_SUBJECT','Rumbostar invite Link');
$friendbody="<strong>Hello %USER_NAME%,</strong><br><br> %SENDER_NAME% has Invited you to connect on Rumbostar.<br/> Please click the link below and register.</p><p><a href='%LINK%' target='_blank'>Activate Account</a> <br><br> Thanks and Regards <br> Rumbostar";

define('FRIEND_BODY',$friendbody);


//sk add following code for user invite friend Referal Code  %MY_REFERAL_CODE%,<br/>
define('DISCOUNT_MGT_SUBJECT','Rumbostar Discount Coupon');
$discountbody="<strong>Hello %USER_NAME%,</strong><br><br> We have been rewarded with %DISCOUNT% discount on next booking.</p><p> Enter Code : %COUPONE_CODE% <br><br> Thanks and Regards <br> Rumbostar";

define('DISCOUNT_BODY',$discountbody);
