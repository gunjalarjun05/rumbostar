...
$route['check_flight_coupon'] = 'service/check_flight_coupon';
...
$route['train/(:any)'] = 'service/train/$1';
...
$route['booking/flight-booking-passenger/(:any)/(:any)/(:any)'] = 'bookings/flight_passenger_list/$1/$2/$3';
$route['booking/flightBookingTickitShare'] = 'bookings/flight_Booking_Tickit_Share';
...
$route['user/customer-details/(:any)'] = 'user/customer_details/$1';
...
$route['user/flight-commission'] = 'user/flight_commission';
$route['user/hotel-commission'] = 'user/hotel_commission';
$route['user/train-commission'] = 'user/train_commission';
$route['booking/view-hotel-booking/(:any)'] = 'bookings/view_hotel_booking/$1';

$route['checkout'] = 'bookings/checkout';
$route['vtweb_checkout'] = 'vtweb/vtweb_checkout';
$route['paypal_checkout'] = 'bookings/paypal_checkout';
$route['train-sitemap'] = 'bookings/train_site_map';