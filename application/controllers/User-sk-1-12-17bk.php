...
class User extends CI_Controller {
    ...
    public function register() {
        ...
        //echo '<pre>';
       // print_r($this->input->post('regsubmit'));exit;
    ...
    public function social_redirect_apply_acc($media){
       ...
       // print_r($user);exit;
        ...
        $result = $this->master_db->select('user_id,users_name,users_email,users_num,users_reg_date,users_status,users_type,social_media_id,user_from,users_updated_date',USERS,array('social_media_id'=>$user['id']));
        ...
        if(count($result)<=0){           
         ...
         // print_r($result[0]->users_status);exit;
