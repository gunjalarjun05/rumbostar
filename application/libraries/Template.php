...
class Template {
   ...
   function __construct($activeTemplate=false)
   {
      ...
      if (isset($template))
      {
		  $this->params = $activeTemplate;
		  $this->config = $template;
		  if(isset($activeTemplate['default_template']) && $activeTemplate['default_template'] !=''){
			  $template['active_template'] = $activeTemplate['default_template'];
		  }
