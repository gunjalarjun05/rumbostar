                       ...
                       <!--  <div class="form-item">
                        ...
                        <div class="form-item">
                            <label>Referral code</label>                            
                              <input type="text" name="referral_code" id="id_referral_code" class="" value="" >
                        ...
                        <input type="hidden" name="social_user_type" id="social_user_type" value="USER">
                        <?php if(isset($parent_user_id) && $parent_user_id != ''){ ?>
                         <input type="hidden" name="parent_user_id" id="parent_user_id" value="<?php echo ($parent_user_id)?$parent_user_id:'0'; ?>">
                        <?php }else{ ?>
                         <input type="hidden" name="parent_user_id" id="parent_user_id" value="0">
                          <?php  } ?>

                          <?php if(isset($invite_user_id) && $invite_user_id != ''){ ?>
                         <input type="hidden" name="invite_referral_code_id" id="invite_referral_code_id" value="<?php echo ($invite_user_id)?$invite_user_id:'0'; ?>">
                        <?php }else{ ?>
                         <input type="hidden" name="invite_referral_code_id" id="invite_referral_code_id" value="0">
                          <?php  } ?>
...
var referral_code = window.location.pathname.split( '/' );  
  sessionStorage.setItem("referral_code", referral_code[3]);
  if(sessionStorage.getItem("referral_code") != 'undefined'){    
    $("#id_referral_code").val(sessionStorage.getItem("referral_code"));
    $('#id_referral_code').attr("readonly", "readonly");
  }else{
     $("#id_referral_code").val("");
     $('#id_referral_code').removeAttr("readonly");
  }
