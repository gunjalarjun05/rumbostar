                    ...
                    <div class="col-md-9 col-md-push-3">
                        <div class="filter-page__content">
                            <div class="filter-item-wrapper">
                                <!-- ITEM -->
                             <h3>TRAIN DETAILS</h3>
                            <?php if(isset($searchinfo->schedule->depart) && count($searchinfo->schedule->depart)>0):?>
                                                        ...
                                                        if(count($schedule->Availability)):?>
                                                            <?php foreach($schedule->Availability as $key=>$avlResc):?>
                                                                 <tr>
                                                                    ...
                                                                    <td class="duration"><a href="<?php echo site_url().'train-details/'.$session_id.'/'.$schedule->train_no.'?'.$subStrNew;?>" class="awe-btn">View Details</a></td>
                                                                </tr>
                                                                <?php
                                            ...
                                            <div class="item-body">
                                                ...
                                                <table class="item-table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $subStr = '';
                                                        $z=1;
                                                        if(count($returnschdule->Availability)):?>
                                                            <?php foreach($schedule->Availability as $key=>$avlResc):?>
                                                                 <tr>
                                                                    <td class="route"><?php echo $avlResc->sub_class;?></td>
                                                                    <td class="depart"> <?php echo $avlResc->class;?></td>
                                                                    ...
                                                                    <td class="duration"><?php echo $avlResc->infant_price;?></td>
                                                                    <?php
                                                                        $subStrNew = 'sub_class_1='.$avlResc->sub_class.'&train_name_1='.$schedule->train_name.'&sub_class_2='.$avlResc->sub_class.'&train_name_2='.$schedule->train_name;
