                 ...
                 <?php $this->load->view('message');?>
                    ...
                    <form method="POST" id="user-reg-form" name="user_reg_form">
                        <div class="form-item">
                            ...
                            <input type="text" name="name" id="id-name" class="only-alphabets disableCopyPast disabledMouseClick" value="<?php echo set_value('name'); ?>">
                        ...
                        <div class="form-item social-media-login registration-page">
                            <div class="login_with_social_media">
                              <ul class="social-buttons">
                                    <li>
                                        <a class="btn btn-block btn-social btn-facebook" title="Login With Facebook" href="<?php echo create_social_media_url('facebook');?>">
