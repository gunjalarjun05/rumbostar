...
<footer id="footer-page">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="widget widget_contact_info">
                    ...
                    <div class="logo">
                        <img src="<?php echo site_url().ASSETS_IMAGES?>logo-footer.png" alt="">
                    </div>
                    <div class="widget_content">
                        <p>25 California Avenue, Santa Monica, California. USA</p>
                        <p>+1-888-8765-1234</p>
                        <a href="mailto:contact@rumboostar.com">contact@rumboostar.com</a>
                    </div>
                </div>
            </div>
            <!-- END / WIDGET -->
        ...
        <div class="copyright">
            <p>©2016 Rumboostar, All rights reserved.</p>
        </div>
    </div>
</footer>
<!-- END / FOOTER PAGE -->
