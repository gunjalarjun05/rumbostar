            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-top">
                            <ul class="list-link">
                                <li class="current"><a href="#">Train</a></li>
                                <li><a href="#">Bus</a></li>
                                <li><a href="#">Boat</a></li>
                            ...
                            <div class="filter-item-wrapper">
                                ...
                                <div class="flight-item">
                                    <div class="item-media">
                                        <div class="image-cover">
                                            <img src="<?php echo site_url().ASSETS_IMAGES?>/flight/1.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="item-body">
                                        <div class="item-title">
                                            <h2>
                                                <a href="">Lufthansa : Hanoi - NYC</a>
                                            </h2>
                                        </div>
                                    ...
                                    <div class="item-price-more">
                                        ...
                                        <a href="<?php echo site_url();?>/service/train_details" class="awe-btn">Book now</a>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="flight-item">
                                    ...
                                    <div class="item-body">
                                        <div class="item-title">
                                            <h2>
                                                <a href="<?php echo site_url();?>/service/train_details">Qatar : Hanoi - NYC</a>
                                            </h2>
                                        </div>
                                        <table class="item-table">
                                            <thead>
