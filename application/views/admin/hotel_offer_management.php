		...
		<div class="col-xs-12">
		  <div class="box">
			<div class="box-header">
			  <h3 class="box-title">Hotel Offer Management</h3>
			  <a href="<?php echo site_url(ADMIN_CONTROLERS.'offer_management/add_hotel_offer');?>" id="add-offer-btn" name="add_offer_btn" class="btn btn-primary btn-xs pull-right">Add Hotel Offer </a>
			</div><!-- /.box-header -->
			<div class="box-body">
			 <div class="enduser">
