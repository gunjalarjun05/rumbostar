		...
		<div class="col-xs-12">
		  <div class="box">
			<div class="box-header">
			  <h3 class="box-title">Train Offer Management</h3>
			 <!--  <a href="<?php //echo site_url(ADMIN_CONTROLERS.'offer_management/add_hotel_offer');?>" id="add-offer-btn" name="add_offer_btn" class="btn btn-primary btn-xs pull-right">Add Train Offer </a> -->
			</div><!-- /.box-header -->
			<div class="box-body">
			 <div class="enduser">
			 <!--  <table id="example1" class="table table-bordered table-striped">
				<thead>
				  <tr>
					...
					<!--<th class="w-80">Hotel Name</th>-->
					<!--<th class="w-80">Offer</th>
				  ...
				  <?php //if(count($offerRes)>0):?>
						<?php //$i=1; foreach($offerRes as $key=>$offerdata):?>
							<tr class="odd gradeX">
								...
								<td class="w-50"><?php //echo $offerdata->hotel_city;?></td>
