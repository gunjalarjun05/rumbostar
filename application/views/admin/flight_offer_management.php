  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
	  ...
	  <ol class="breadcrumb">
		...
		<li><a href="#">Flight Offer Management </a></li>
	  </ol>
	</section>
		...
		<div class="col-xs-12">
		  <div class="box">
			<div class="box-header">
			  <h3 class="box-title">Flight Offer Management</h3>
			  <a href="<?php echo site_url(ADMIN_CONTROLERS.'offer_management/add_flight_offer');?>" id="add-offer-btn" name="add_offer_btn" class="btn btn-primary btn-xs pull-right">Add Flight Offer </a>
			</div><!-- /.box-header -->
			<div class="box-body">
			 <div class="enduser">
				  ...
				  <?php if(count($offerRes)>0):?>
						<?php $i=1; foreach($offerRes as $key=>$offerdata):?>
							<tr class="odd gradeX">
								...
								<td class="w-50"><?php echo $offerdata->flight_name;?></td>
								<td class="w-50"><?php echo $offerdata->flight_code;?></td>
