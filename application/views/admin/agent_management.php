				  ...
				  if(count($userRes)>0):?>
						<?php $i=1; foreach($userRes as $key=>$userdata):?>
							<tr class="odd gradeX">
								...
								<td class="w-150 center"><?php echo $userdata->agent_id;?></td>
								...
								<td class="w-150 center">
									...
									<select name="userstatus" id="userstatus" onchange="change_agent_status('<?php echo $userdata->user_id;?>',this,'<?php echo $userdata->users_type;?>','<?php echo $userdata->users_name ?>','<?php echo $userdata->users_email;?>','<?php echo $userdata->agent_id;?>')">
