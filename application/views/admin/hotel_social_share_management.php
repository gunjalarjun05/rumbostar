		...
		<div class="col-xs-12">
		  <div class="box">
			<div class="box-header">
			  <h3 class="box-title">Hotel Social Share Management</h3>
			 <!--  <a href="<?php //echo site_url(ADMIN_CONTROLERS.'social_sharing_management/add_Hotel_offer');?>" id="add-offer-btn" name="add_offer_btn" class="btn btn-primary btn-xs pull-right">Add Hotel Discount </a> -->
			</div><!-- /.box-header -->
			<div class="box-body">
			 <div class="enduser">
			  <table id="example1" class="table table-bordered table-striped">
				  ...
				  <?php //if(count($offerRes)>0):?>
						<?php //$i=1; foreach($offerRes as $key=>$offerdata):?>
							<tr class="odd gradeX">
								...
								<td class="w-50"><?php //echo $offerdata->Hotel_name;?></td>
								<td class="w-50"><?php //echo $offerdata->Hotel_code;?></td>
								...
								<td class="w-150 center">	
									...
									<a href="<?php //echo site_url(ADMIN_CONTROLERS.'offer_management/add_Hotel_offer/'.encode_string($offerdata->offer_id))?>" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>														
								</td>
							</tr>
						<?php //$i++; endforeach;?>
					<?php //endif;?>
				...
				<tfoot>
				  <!-- <tr>
					<th class="w-50">#</th>
					<th class="w-50">Hotel Name</th>
					<th class="w-50">Hotel Code</th>
