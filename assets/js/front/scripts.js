...
(function($) {
    ...
    function priceSlider() {
        $('.price-slider').each(function() {
            ...
            var range_slide_min = 0;
             var range_slide_max = 10000000;
            if(priceslider.attr("id") == "price_slider"){
                if($("#range-slide-min").val().trim() == ''){
                    var range_slide_min = 0;
                }else{
                    var range_slide_min = $("#range-slide-min").val();
                }
                if($("#range-slide-max").val().trim() == ''){
                    var range_slide_max = 10000000;
                }else{
                    var range_slide_max = $("#range-slide-max").val();
                }
            }
            ...
            priceslider.slider({
                ...
                max: 10000000,
                step: 10000,
                values: [ parseInt(range_slide_min), parseInt(range_slide_max) ],
                range: true,
                slide: function( event, ui ) {
                    var $this=$(this),
                        values=ui.values;
                    priceslider.siblings('.price_slider_amount').find('.from').text('Rp' + values[0]);
                    priceslider.siblings('.price_slider_amount').find('.to').text('Rp' + values[1]);
                    if(priceslider.attr("id") == "price_slider"){
                        priceslider.siblings('.price_slider_amount').find('#range-slide-min').val(values[0]);
                        priceslider.siblings('.price_slider_amount').find('#range-slide-max').val(values[1]);
                    }
                }
            });
            ...
            priceslider.siblings('.price_slider_amount').find('.from').text(currency+' '+ values[0]);
            priceslider.siblings('.price_slider_amount').find('.to').text(currency+' ' + values[1]);
        });
    }
